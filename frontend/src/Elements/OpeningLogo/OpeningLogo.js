...
const OpeningLogo= ({onRouteChange , onButtonSubmit2}) => {
    return(
        <div style={{ width: 'auto', height: '100vh' }} className='OpeningPic paOpeningLogo f1'>
            ...
            <h5 className='f4 white center tShadow'>Here we are going to write some thing ammazing about our company so that costomer can see it</h5>
            <div className='patop'>
            <button onClick={() => onRouteChange('partupload')}
            className='btn center grow f3 ttu link white black bgOK shadow-5 pointer bn'><h2>Quote Now</h2></button>
            <br/>
